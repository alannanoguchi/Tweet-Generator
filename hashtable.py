...
class HashTable(object):
    ...
    def keys(self):
        ...
        TODO: Running time: O(???) Why and under what conditions? - O(n), it loops through the keys one time"""
    ...
    def values(self):
        ...
        TODO: Running time: O(???) Why and under what conditions? - O(n), it loops through the values one time"""
    ...
    def items(self):
        ...
        TODO: Running time: O(???) Why and under what conditions? - O(n), it loops through every item"""
    ...
    def length(self):
        ...
        TODO: Running time: O(???) Why and under what conditions? - O(n), it iterates through then entire length"""
        # TODO: Loop through all buckets
    ...
    def contains(self, key):
        ...
        TODO: Running time: O(???) Why and under what conditions? - O(n/b), is the average case for the length of each bucket"""
    ...
    def get(self, key):
        ...
        TODO: Running time: O(???) Why and under what conditions? - O(n/b), it is the avaerage cse for the lenght of each bucket"""
        # TODO: Find bucket where given key belongs
        # TODO: Check if key-value entry exists in bucket
    ...
    def delete(self, key):
        ...
        TODO: Running time: O(???) Why and under what conditions? - O(n/b), this is the average case for iterating through a bucket looking for an item"""
        # TODO: Find bucket where given key belongs
        # TODO: Check if key-value entry exists in bucket
